 ...
 *
 * It would be preferable to filter ass_get_login_redirect_url() in the first
 * place instead of redirecting but that's not possible yet.
 */
function hcommons_redirect_bpnoaccess() {
	if (
		isset( $_REQUEST['action'] ) &&
		'bpnoaccess' === $_REQUEST['action']
	) {
...
add_action( 'login_init', 'hcommons_redirect_bpnoaccess' );
